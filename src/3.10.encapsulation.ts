{
//Encapsulation=> be using modifier private. protected we can deny access of variable or methods outside class.. this is called encapsulation
...
console.log(goriberAccount.getHiddenMethod())//output:400
